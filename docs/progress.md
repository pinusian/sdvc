...
> 마지막 업데이트: 2026-09-12 (작업 휴식) · 프로젝트: SDVC 웹서비스 · 현재 단계: **Phase 6(결제) 완료 — ★게이트 G6 통과** → 다음 세션은 **Phase 7(유지보수 본체)부터 시작**(2026-09-12 사용자 지시)
...
- **다음: Phase 7 — 유지보수 본체**(2026-09-12 사용자가 1번으로 지정). 실결제 전환은 그 뒤로 미룸
  - **착수 전 할 일**: Phase 7에 대해 Block1(Specify 보완)~Block4(Tasks)를 간략히 반복해 `tasks.md`에 슬라이스 6을 추가한다(§6 함정 참조). 그 전에는 코드를 건드리지 않는다
  - 범위: P7-2·P7-3 버그 등록·추적, P7-4 기능요청 흐름, P7-6 롤백. 진입점([P5-4b] "이어서 수정")과 유지보수 프롬프트(`MAINTENANCE_SECTION`)는 이미 있다
