...
> 마지막 업데이트: 2026-09-11 · 프로젝트: SDVC 웹서비스 · 현재 단계: **MVP 완료 후 Phase 6(결제) 진행 중 — [P6-2]·[P6-3]·[P6-4] 완료** → 다음 **[P6-5] Stripe Checkout 연동 (Stripe 가입 필요)**
...
- [ ] **[P6-5]** Stripe Checkout 연동 — **여기서 사용자의 Stripe 가입·키 등록이 필요하다**
- [ ] **[P6-6]** Webhook + 등급 자동 전환 · [ ] **[P6-7]** 체험/해지 시 산출물 처리 · [ ] **[P6-8]** 요금제·결제 화면 · [ ] **[P6-9]** 게이트 G6
